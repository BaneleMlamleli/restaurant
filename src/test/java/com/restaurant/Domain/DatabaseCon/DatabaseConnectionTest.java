...
import static com.restaurant.Domain.DatabaseCon.DatabaseTest.*;
...
public class DatabaseConnectionTest {
    ...
    public static boolean verifyUser(String username, String password, String title) throws SQLException{
        ...
        try{
            ...
            System.out.println("UserImplementationTest verification executed");
        }catch(SQLSyntaxErrorException see){
            see.printStackTrace();
        }catch(SQLException ex){
            ex.printStackTrace();
    ...
    public static void insertOrderDetails(String orderComment, String order_name, String selectedTable, String waiterName, String orderStatus, double bill, String date) throws SQLException{
        try{
            ...
            prepStatement.execute();
            System.out.println("OrderImplementationTest has been placed successfully");
        }catch(SQLSyntaxErrorException see){
            see.printStackTrace();
        }catch(SQLException ex){
            ex.printStackTrace();
     ...
     * the response in an ArrayList object of type StockImplementationTest
     * @return 
     * @throws SQLException
     */
    public static ArrayList<StockTest> selectAllStock() throws SQLException{
        ArrayList<StockTest> stockTest = new ArrayList<>();
        try{
            // creating the statement
            statement = connection.createStatement();
            // execute the sql query
            ...
            // processing the results to very the entered login details
            while(resultset.next()){
               // stockTest.add(new StockImplementationTest(resultset.getString("item_name"), resultset.getInt("usage")));
            }
            System.out.println("All StockImplementationTest data read successfully");
        }catch(SQLSyntaxErrorException see){
            see.printStackTrace();
        }catch(SQLException ex){
            ex.printStackTrace();
     ...
     * the response in an ArrayList object of type OrderImplementationTest
     * @return 
     * @throws SQLException
     */
    public static ArrayList<OrderTest> selectAllOrders() throws SQLException{
        ArrayList<OrderTest> orderTest = new ArrayList<>();
        try{
            // creating the statement
            statement = connection.createStatement();
            // execute the sql query
            ...
            while(resultset.next()){
                ...
                // orderTest.add(new OrderImplementationTest(order_id, comment, order_name, table_name, waiter_name, order_status, order_date, order_bill));
            }
            System.out.println("All OrderImplementationTest data read successfully");
        }catch(SQLSyntaxErrorException see){
            see.printStackTrace();
        }catch(SQLException ex){
            ex.printStackTrace();
     ...
     * the response in an ArrayList object of type TableRepositoryTest
     * @return
     * @throws SQLException
     */
    public static ArrayList<TableTest> selectAllTables() throws SQLException{
        ArrayList<TableTest> tableTest = new ArrayList<>();
        try{
            // creating the statement
            statement = connection.createStatement();
            // execute the sql query
            ...
            while(resultset.next()){
                ...
                String table_name = resultset.getString("table_name");
                String waiter_name = resultset.getString("waiter_name");
                // tableTest.add(new TableImplementation(table_id, table_status, table_name, waiter_name));
            }
            System.out.println("All TableRepositoryTest data read successfully");
        }catch(SQLSyntaxErrorException see){
            see.printStackTrace();
        }catch(SQLException ex){
            ex.printStackTrace();
